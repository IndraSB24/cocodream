                                    ...
                                    <div class="card-body">
                                            <div class="row">
                                                <div class="col-12 text-center">
                                                    <h2>CASH DRAWER DETAIL</h2>
                                                    <h4><?= indoDate($for_date) ?></h4>
                                                </div>
                                            </div>
                                            <hr>
...
<script>
    ...
    function mainDatatable() {
        ...
        mainTable = $('#main_table').DataTable({
            ...
            ajax: {
                "url": "<?php echo site_url('cash_drawer/ajax_get_list_cashdrawer_detail/'.$id_entitas.'/'.$for_date)?>",
                "type": "POST",
                "data": function ( data ) {
    ...
    $(document).on('click', '#btn_konfirmasi_add_detail', function () {
        ...
        loadQuestionalSwal(
            ...
            'Ditambahkan!', 'Detail baru berhasil ditambahkan pada Cash Drawer untuk Tanggal <?= indoDate($for_date) ?>', 'modal_add'
        );
    });
